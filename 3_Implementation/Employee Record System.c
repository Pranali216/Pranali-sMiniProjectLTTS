...
{
    char lastName[MAX_LAST_NAME];// declare the character data type
...
void searchEmployee()
{
    ...
    if(found)
    {
        ...
        printf("\t\t\tLast Name = %s",addEmployeeInfoInDataBase.lastName);
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="LTTS\n";
    const char defaultPassword[] ="LTTS2021\n";
    sFileHeader fileHeaderInfo = {0};
